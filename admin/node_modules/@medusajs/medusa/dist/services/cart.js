...
var CartService = /** @class */ (function (_super) {
    ...
    CartService.prototype.retrieve = function (cartId, options, totalsConfig) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var totalsToSelect, cartRepo, query, raw;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    CartService.prototype.addShippingMethod = function (cartOrId, optionId, data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var cart, _a, cartCustomShippingOptions, customShippingOption, shipping_methods, shippingMethodConfig, newShippingMethod, methods, shippingOptionServiceTx, shipping_methods_1, shipping_methods_1_1, shippingMethod, e_3_1, lineItemServiceTx_1, updatedCart;
                            var e_3, _b;
                            var _this = this;
                            var _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    case 0:
                                        if (!!(0, utils_1.isString)(cartOrId)) return [3 /*break*/, 1];
                                        _a = cartOrId;
                                        return [3 /*break*/, 3];
                                    ...
                                    case 13:
                                        ...
                                        return [7 /*endfinally*/];
                                    case 14:
                                        if (!((_c = cart.items) === null || _c === void 0 ? void 0 : _c.length)) return [3 /*break*/, 16];
                                    ...
                                    case 15:
                                        _d.sent();
                                        _d.label = 16;
                                    case 16: return [4 /*yield*/, this.retrieve(cart.id, {
                                    ...
                                    case 18:
                                        _d.sent();
                                        _d.label = 19;
                                    case 19: return [4 /*yield*/, this.eventBus_
                                            .withTransaction(transactionManager)
                                            .emit(CartService.Events.UPDATED, updatedCart)];
                                    case 20:
                                        _d.sent();
    ...
    CartService.prototype.updateUnitPrices_ = function (cart, regionId, customer_id) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var region_1, lineItemServiceTx_2, _b;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!((_a = cart.items) === null || _a === void 0 ? void 0 : _a.length)) return [3 /*break*/, 3];
                    ...
                    case 1:
                        region_1 = _c.sent();
                        lineItemServiceTx_2 = this.lineItemService_.withTransaction(this.activeManager_);
                        _b = cart;
                        return [4 /*yield*/, Promise.all(cart.items.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                                var availablePrice;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            if (!(availablePrice !== undefined &&
                                                availablePrice.calculatedPrice !== null)) return [3 /*break*/, 4];
                                        ...
                                        case 2:
                                            _a.sent();
                                            return [4 /*yield*/, lineItemServiceTx_2.retrieve(item.id, {
                                                    relations: ["variant", "variant.product"],
                                                })];
                                        case 3: return [2 /*return*/, _a.sent()];
                                        case 4: return [4 /*yield*/, lineItemServiceTx_2.delete(item.id)];
    ...
    CartService.prototype.setRegion_ = function (cart, regionId, countryCode) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var region, addrRepo, shippingAddress, updated, updated, paymentSessionRepo;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 10:
                        ...
                        if (!((_a = cart === null || cart === void 0 ? void 0 : cart.items) === null || _a === void 0 ? void 0 : _a.length)) return [3 /*break*/, 12];
    ...
    CartService.prototype.decorateTotals = function (cart, totalsConfig) {
        ...
        if (totalsConfig === void 0) { totalsConfig = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var newTotalsServiceTx, calculationContext, includeTax, cartItems, cartShippingMethods, taxLinesMaps_1, itemsTotals, shippingTotals, giftCardTotal;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
