                ...
                switch (_d.label) {
                    case 0:
                        ...
                        fetchSelectColumns = function (relationName) {
                            ...
                            var selectColumns = columnsSelected.length ? columnsSelected : modelColumns;
                        ...
                        if (q) {
                            ...
                            options_.where = [__assign(__assign({}, options_.where), { name: (0, typeorm_1.ILike)("%".concat(q, "%")) }), __assign(__assign({}, options_.where), { handle: (0, typeorm_1.ILike)("%".concat(q, "%")) })];
                        }
                        ...
                        includedTreeRelations.forEach(function (treeRelation) {
                            ...
                            queryBuilder
                                ...
                                .addOrderBy("".concat(treeRelation, ".rank"), "ASC")
                                .addOrderBy("".concat(treeRelation, ".handle"), "ASC");
                        });
                    ...
                    case 1:
                        ...
                        if (!includeTree) return [3 /*break*/, 3];
                        return [4 /*yield*/, Promise.all(categories.map(function (productCategory) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.findDescendantsTree(productCategory)];
                                        case 1:
                                            productCategory = _a.sent();
                                            return [2 /*return*/, sortChildren(productCategory, treeScope)];
                                    }
                                });
                            }); }))];
                    case 2:
                        categories = _d.sent();
                        _d.label = 3;
                    case 3: return [2 /*return*/, [categories, count]];
                }
            });
        });
    },
...
var sortChildren = function (category, treeScope) {
    ...
    if (category.category_children) {
        category.category_children = category === null || category === void 0 ? void 0 : category.category_children.map(
        // Before we sort the children, we need scope the children
        // to conform to treeScope conditions
        function (child) { return sortChildren(scopeChildren(child, treeScope), treeScope); }).sort(function (a, b) { return a.rank - b.rank; });
    }
    return category;
};
