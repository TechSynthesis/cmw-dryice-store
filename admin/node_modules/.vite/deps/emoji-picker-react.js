...
function basePickerConfig() {
  return {
    ...
    onEmojiClick: function defaultOnClickHandler(emoji, event) {
    },
    ...
    theme: Theme.LIGHT,
    width: 350,
    unicodeToHide: /* @__PURE__ */ new Set()
  };
}
...
function useSearchPlaceHolderConfig() {
  var _usePickerConfig = usePickerConfig(), searchPlaceHolder = _usePickerConfig.searchPlaceHolder;
...
function useOnEmojiClickConfig() {
  var _usePickerConfig7 = usePickerConfig(), onEmojiClick = _usePickerConfig7.onEmojiClick;
  return onEmojiClick;
}
...
function usePickerSizeConfig() {
  var _usePickerConfig12 = usePickerConfig(), height = _usePickerConfig12.height, width = _usePickerConfig12.width;
  return {
...
function useEmojiVersionConfig() {
  var _usePickerConfig13 = usePickerConfig(), emojiVersion = _usePickerConfig13.emojiVersion;
  return emojiVersion;
}
function useSearchDisabledConfig() {
  var _usePickerConfig14 = usePickerConfig(), searchDisabled = _usePickerConfig14.searchDisabled;
  return searchDisabled;
}
function useSkinTonePickerLocationConfig() {
  var _usePickerConfig15 = usePickerConfig(), skinTonePickerLocation = _usePickerConfig15.skinTonePickerLocation;
  return skinTonePickerLocation;
}
function useUnicodeToHide() {
  var _usePickerConfig16 = usePickerConfig(), unicodeToHide = _usePickerConfig16.unicodeToHide;
  return unicodeToHide;
}
function useGetEmojiUrlConfig() {
  var _usePickerConfig17 = usePickerConfig(), getEmojiUrl = _usePickerConfig17.getEmojiUrl;
  return getEmojiUrl;
}
...
function useSearchTermState() {
  var _React$useContext4 = (0, import_react.useContext)(PickerContext), searchTerm = _React$useContext4.searchTerm;
  return searchTerm;
}
function useActiveSkinToneState() {
  var _React$useContext5 = (0, import_react.useContext)(PickerContext), activeSkinTone = _React$useContext5.activeSkinTone;
  return activeSkinTone;
}
function useEmojisThatFailedToLoadState() {
  var _React$useContext6 = (0, import_react.useContext)(PickerContext), emojisThatFailedToLoadState = _React$useContext6.emojisThatFailedToLoadState;
  return emojisThatFailedToLoadState;
}
function useIsPastInitialLoad() {
  var _React$useContext7 = (0, import_react.useContext)(PickerContext), isPastInitialLoad = _React$useContext7.isPastInitialLoad;
  return isPastInitialLoad;
}
function useEmojiVariationPickerState() {
  var _React$useContext8 = (0, import_react.useContext)(PickerContext), emojiVariationPickerState = _React$useContext8.emojiVariationPickerState;
  return emojiVariationPickerState;
}
function useSkinToneFanOpenState() {
  var _React$useContext9 = (0, import_react.useContext)(PickerContext), skinToneFanOpenState = _React$useContext9.skinToneFanOpenState;
  return skinToneFanOpenState;
}
function useUpdateSuggested() {
  var _React$useContext11 = (0, import_react.useContext)(PickerContext), suggestedUpdateState = _React$useContext11.suggestedUpdateState;
...
function Button(props) {
  return (0, import_react.createElement)("button", Object.assign({
    ...
    className: clsx_m_default("epr-btn", props.className)
  }), props.children);
}
...
function ClickableEmoji(_ref) {
  var _clsx;
  var emoji = _ref.emoji, unified = _ref.unified, hidden = _ref.hidden, hiddenOnSearch = _ref.hiddenOnSearch, emojiStyle = _ref.emojiStyle, _ref$showVariations = _ref.showVariations, showVariations = _ref$showVariations === void 0 ? true : _ref$showVariations, size = _ref.size, lazyLoad = _ref.lazyLoad, getEmojiUrl = _ref.getEmojiUrl;
  var hasVariations = emojiHasVariations(emoji);
  return (0, import_react.createElement)(Button, {
    className: clsx_m_default(ClassNames.emoji, (_clsx = {}, _clsx[ClassNames.hidden] = hidden, _clsx[ClassNames.hiddenOnSearch] = hiddenOnSearch, _clsx[ClassNames.visible] = !hidden && !hiddenOnSearch, _clsx[ClassNames.emojiHasVariations] = hasVariations && showVariations, _clsx)),
...
function ViewOnlyEmoji(_ref2) {
  var emoji = _ref2.emoji, unified = _ref2.unified, emojiStyle = _ref2.emojiStyle, size = _ref2.size, lazyLoad = _ref2.lazyLoad, _ref2$getEmojiUrl = _ref2.getEmojiUrl, getEmojiUrl = _ref2$getEmojiUrl === void 0 ? emojiUrlByUnified : _ref2$getEmojiUrl;
  var style = {};
  if (size) {
...
function NativeEmoji(_ref3) {
  var unified = _ref3.unified, style = _ref3.style;
  return (0, import_react.createElement)("span", {
    className: clsx_m_default(ClassNames.external, "epr-emoji-native"),
    "data-unified": unified,
    style
  }, parseNativeEmoji(unified));
}
function EmojiImg(_ref4) {
  var emoji = _ref4.emoji, unified = _ref4.unified, emojiStyle = _ref4.emojiStyle, style = _ref4.style, _ref4$lazyLoad = _ref4.lazyLoad, lazyLoad = _ref4$lazyLoad === void 0 ? false : _ref4$lazyLoad, getEmojiUrl = _ref4.getEmojiUrl;
  ...
  return (0, import_react.createElement)("img", {
    ...
    alt: emojiName(emoji),
    className: clsx_m_default(ClassNames.external, "epr-emoji-img"),
...
function EmojiCategory(_ref) {
  ...
  return (0, import_react.createElement)("li", {
    className: clsx_m_default(ClassNames.category, (_clsx = {}, _clsx[ClassNames.hidden] = hidden, _clsx[ClassNames.hiddenOnSearch] = hiddenOnSearch, _clsx)),
    "data-name": category,
...
function RenderCategory(_ref) {
  var index = _ref.index, category = _ref.category, categoryConfig = _ref.categoryConfig;
...
function EmojiVariationPicker() {
  ...
  return (0, import_react.createElement)("div", {
    ...
    className: clsx_m_default(ClassNames.variationPicker, {
      visible,
...
function Flex(_ref) {
  ...
  return (0, import_react.createElement)("div", {
    ...
    className: clsx_m_default("Flex", className, direction)
  }, children);
}
function Space(_ref) {
...
function SkinTonePicker(_ref) {
  ...
  return (0, import_react.createElement)(Relative, {
    className: clsx_m_default("epr-skin-tones", direction, (_clsx = {}, _clsx[ClassNames.open] = isOpen, _clsx)),
    style: vertical ? {
    ...
    return (0, import_react.createElement)(Button, {
      style: {
        transform: clsx_m_default(vertical ? "translateY(-" + i * (isOpen ? ITEM_SIZE : 0) + "px)" : "translateX(-" + i * (isOpen ? ITEM_SIZE : 0) + "px)", isOpen && active && "scale(1.3)")
      },
      ...
      className: clsx_m_default("epr-tone-" + skinToneVariation, "epr-tone", (_clsx2 = {}, _clsx2[ClassNames.active] = active, _clsx2)),
      tabIndex: isOpen ? 0 : -1,
      "aria-pressed": active,
...
function PreviewBody() {
  ...
  function PreviewContent() {
    ...
    return (0, import_react.createElement)(import_react.Fragment, null, (0, import_react.createElement)("div", null, show ? (0, import_react.createElement)(ViewOnlyEmoji, {
      ...
      size: 45,
      getEmojiUrl
    }) : null), show ? (0, import_react.createElement)("div", {
      className: "epr-preview-emoji-label"
    }, emojiName(emoji)) : (0, import_react.createElement)("div", {
      className: "epr-preview-emoji-label"
    }, defaultText));
  }
}
...
function CategoryNavigation() {
  ...
  return (0, import_react.createElement)("div", {
    ...
    return (0, import_react.createElement)(Button, {
      ...
      className: clsx_m_default("epr-cat-btn", "epr-icn-" + category, (_clsx = {}, _clsx[ClassNames.active] = category === activeCategory, _clsx)),
      key: category,
      onClick: function onClick() {
...
function Search() {
  ...
  var _useFilter = useFilter(), _onChange = _useFilter.onChange;
  ...
  return (0, import_react.createElement)(Relative, {
    ...
    className: clsx_m_default("epr-btn-clear-search", "epr-visible-on-search-only"),
    onClick: clearSearch
  }, (0, import_react.createElement)("div", {
    className: "epr-icn-clear-search"
  })));
}
var CSS_SEARCH_SELECTOR = asSelectors(ClassNames.emojiPicker) + " " + asSelectors(ClassNames.emojiList);
...
function PickerRootElement(_ref2) {
  ...
  var PickerMainRef = usePickerMainRef();
  var _usePickerSizeConfig = usePickerSizeConfig(), height = _usePickerSizeConfig.height, width = _usePickerSizeConfig.width;
  ...
  return (0, import_react.createElement)("aside", {
    className: clsx_m_default(ClassNames.emojiPicker, "epr-main", (_clsx = {}, _clsx[ClassNames.searchActive] = searchModeActive, _clsx["epr-dark-theme"] = theme === Theme.DARK, _clsx)),
    ref: PickerMainRef,
    style
  }, children);
}
...
function EmojiPicker(props) {
  return (0, import_react.createElement)(ElementRefContextProvider, null, (0, import_react.createElement)(PickerConfigProvider, Object.assign({}, props), (0, import_react.createElement)(PickerMain, null, (0, import_react.createElement)(Header, null), (0, import_react.createElement)(Body, null), (0, import_react.createElement)(Preview, null))));
}
...
function ExportedEmoji(_ref) {
  var unified = _ref.unified, _ref$size = _ref.size, size = _ref$size === void 0 ? 32 : _ref$size, _ref$emojiStyle = _ref.emojiStyle, emojiStyle = _ref$emojiStyle === void 0 ? EmojiStyle.APPLE : _ref$emojiStyle, _ref$lazyLoad = _ref.lazyLoad, lazyLoad = _ref$lazyLoad === void 0 ? false : _ref$lazyLoad, getEmojiUrl = _ref.getEmojiUrl;
  if (!unified) {
    return null;
  }
...
function EmojiPicker$1(props) {
  return (0, import_react.createElement)(ErrorBoundary, null, (0, import_react.createElement)(EmojiPicker, Object.assign({}, props)));
}
