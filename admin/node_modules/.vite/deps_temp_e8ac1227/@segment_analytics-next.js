import {
  ...
  mergedOptions,
  pWhile
} from "./chunk-M6JD56Q5.js";
import {
  getCDN,
  loadScript,
  setGlobalCDNUrl
} from "./chunk-AHDJ5OXR.js";
import {
  Context,
  Cookie,
  Group,
...
var resolveUserArguments = function(user) {
  return function() {
    ...
    var id = null;
    id = (_c = (_a2 = args.find(isString)) !== null && _a2 !== void 0 ? _a2 : (_b2 = args.find(isNumber)) === null || _b2 === void 0 ? void 0 : _b2.toString()) !== null && _c !== void 0 ? _c : user.id();
    var objects = args.filter(function(obj) {
      if (id === null) {
        return isPlainObject(obj);
      }
...
var EventFactory = (
  ...
  function() {
    ...
    EventFactory2.prototype.normalize = function(event) {
      ...
      var body = __assign(__assign(__assign({ timestamp: /* @__PURE__ */ new Date() }, rest), { context, integrations: allIntegrations }), overrides);
...
var Analytics = (
  ...
  function(_super) {
    ...
    function Analytics2(settings, options, queue, user, group) {
      ...
      _this._user = user !== null && user !== void 0 ? user : new User(disablePersistance ? __assign(__assign({}, options === null || options === void 0 ? void 0 : options.user), { persist: false }) : options === null || options === void 0 ? void 0 : options.user, cookieOptions).load();
      _this._group = group !== null && group !== void 0 ? group : new Group(disablePersistance ? __assign(__assign({}, options === null || options === void 0 ? void 0 : options.group), { persist: false }) : options === null || options === void 0 ? void 0 : options.group, cookieOptions).load();
    ...
    Analytics2.prototype.track = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, name, data, opts, cb, segmentEvent;
        var _this = this;
    ...
    Analytics2.prototype.page = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, category, page, properties, options, callback, segmentEvent;
        var _this = this;
        return __generator(this, function(_b2) {
    ...
    Analytics2.prototype.identify = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, id, _traits, options, callback, segmentEvent;
        var _this = this;
        return __generator(this, function(_b2) {
    ...
    Analytics2.prototype.alias = function() {
      ...
      return __awaiter(this, void 0, void 0, function() {
        var _a2, to, from, options, callback, segmentEvent;
        var _this = this;
        return __generator(this, function(_b2) {
...
function canonical() {
  ...
  if (canon) {
    return canon.getAttribute("href") || void 0;
  }
}
...
function enrichPageContext(ctx) {
  ...
  var pageContextFromEventProps = void 0;
  if (event.type === "page") {
    pageContextFromEventProps = event.properties && pick(event.properties, Object.keys(defaultPageContext));
...
function segmentio(analytics, settings, integrations) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    var writeKey, buffer, inflightEvents, flushing, apiHost, protocol, remote, deliveryStrategy, client, userAgentData, _d, segmentio2;
    return __generator(this, function(_e) {
      switch (_e.label) {
        case 0:
          ...
          writeKey = (_a2 = settings === null || settings === void 0 ? void 0 : settings.apiKey) !== null && _a2 !== void 0 ? _a2 : "";
          ...
          inflightEvents = /* @__PURE__ */ new Set();
          flushing = false;
          apiHost = (_b2 = settings === null || settings === void 0 ? void 0 : settings.apiHost) !== null && _b2 !== void 0 ? _b2 : SEGMENT_API_HOST;
          ...
          client = (deliveryStrategy === null || deliveryStrategy === void 0 ? void 0 : deliveryStrategy.strategy) === "batching" ? batch(apiHost, deliveryStrategy.config) : fetch_dispatcher_default(deliveryStrategy === null || deliveryStrategy === void 0 ? void 0 : deliveryStrategy.config);
          _e.label = 1;
        case 1:
          _e.trys.push([1, 3, , 4]);
          return [4, clientHints(analytics.options.highEntropyValuesClientHints)];
        case 2:
...
var PreInitMethodCallBuffer = (
  ...
  function() {
    ...
    PreInitMethodCallBuffer2.prototype.toArray = function() {
      var _a2;
      return (_a2 = []).concat.apply(_a2, Object.values(this._value));
    };
    PreInitMethodCallBuffer2.prototype.getCalls = function(methodName) {
      var _a2;
      return (_a2 = this._value[methodName]) !== null && _a2 !== void 0 ? _a2 : [];
    };
...
function transformSnippetCall(_a2) {
      ...
      switch (_j.label) {
        case 0:
          ...
          return [4, import(
            ...
            "./routing-middleware-LYQEQAOH.js"
          ).then(function(mod) {
        ...
        case 6:
          ...
          return [4, import(
            ...
            "./legacy-video-plugins-WUIKDM7C.js"
          ).then(function(mod) {
        ...
        case 11:
          ...
          return [4, remoteLoader(legacySettings, analytics.integrations, mergedSettings, options.obfuscate, tsubMiddleware).catch(function() {
            return [];
          })];
        case 12:
