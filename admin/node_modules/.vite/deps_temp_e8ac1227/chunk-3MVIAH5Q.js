  ...
  "node_modules/obj-case/index.js"(exports, module) {
    ...
    function multiple(fn) {
      return function(obj, path, val, options) {
        var normalize2 = options && isFunction(options.normalizer) ? options.normalizer : defaultNormalize;
...
var require_group = __commonJS({
  "node_modules/@segment/facade/dist/group.js"(exports) {
    ...
    var new_date_1 = __importDefault(require_lib2());
    var facade_1 = require_facade();
    function Group3(dictionary, opts) {
      facade_1.Facade.call(this, dictionary, opts);
    }
    exports.Group = Group3;
    inherits_1.default(Group3, facade_1.Facade);
    var g = Group3.prototype;
    g.action = function() {
      return "group";
    };
    g.type = g.action;
...
var Store = (
  ...
  function() {
    ...
    Store2.prototype.set = function(key, value) {
      this.cache[key] = value;
    };
    Store2.prototype.remove = function(key) {
      delete this.cache[key];
    };
    Object.defineProperty(Store2.prototype, "type", {
      get: function() {
        return "memory";
      },
      enumerable: false,
  ...
  function(_super) {
    ...
    Cookie2.available = function() {
      try {
        ...
        js_cookie_default.set(PROBE_COOKIE, "test");
        var cookieEnabled = document.cookie.includes(PROBE_COOKIE);
        js_cookie_default.remove(PROBE_COOKIE);
    ...
    Object.defineProperty(Cookie2.prototype, "type", {
      get: function() {
        return "cookie";
      },
      enumerable: false,
...
var LocalStorage = (
  ...
  function(_super) {
    ...
    Object.defineProperty(LocalStorage2.prototype, "type", {
      get: function() {
        return "localStorage";
      },
      enumerable: false,
...
var UniversalStorage = (
  /** @class */
  function() {
    function UniversalStorage2(stores, storageOptions) {
      this.storageOptions = storageOptions;
      this.enabledStores = stores;
    }
    UniversalStorage2.prototype.getStores = function(storeTypes) {
      var _this = this;
      var stores = [];
    ...
    UniversalStorage2.prototype.set = function(key, value, storeTypes) {
      for (var _i = 0, _a = this.getStores(storeTypes); _i < _a.length; _i++) {
        var store = _a[_i];
        store.set(key, value);
      }
    };
    UniversalStorage2.prototype.clear = function(key, storeTypes) {
      for (var _i = 0, _a = this.getStores(storeTypes); _i < _a.length; _i++) {
        var store = _a[_i];
        store.remove(key);
      }
...
function getAvailableStorageOptions(cookieOptions2) {
  return {
    cookie: Cookie.available() ? new Cookie(cookieOptions2) : void 0,
    localStorage: LocalStorage.available() ? new LocalStorage() : void 0,
    memory: new Store()
  };
}
var User = (
  ...
  function() {
    function User2(options, cookieOptions2) {
      ...
      this.anonymousId = function(id) {
        ...
        if (id === void 0) {
          var val = (_a2 = _this.identityStore.getAndSync(_this.anonKey)) !== null && _a2 !== void 0 ? _a2 : (_b2 = _this.legacySIO()) === null || _b2 === void 0 ? void 0 : _b2[0];
          if (val) {
            return val;
          }
        }
      ...
      this.traits = function(traits) {
        ...
        return (_a2 = _this.traitsStore.get(_this.traitsKey)) !== null && _a2 !== void 0 ? _a2 : {};
      };
      ...
      var storageOptions = getAvailableStorageOptions(cookieOptions2);
...
var Group = (
  ...
  function(_super) {
    ...
    function Group3(options, cookie) {
      if (options === void 0) {
...
*/
//# sourceMappingURL=chunk-3MVIAH5Q.js.map
