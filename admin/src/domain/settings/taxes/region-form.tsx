    ...
    <form className="flex flex-1 flex-col" onSubmit={handleSubmit(onSubmit)}>
      <div className="gap-base flex flex-1 flex-col">
        ...
        <div className="item-center flex gap-x-1.5">
          ...
          <IconTooltip
            content={
              "When checked TechInverted eCommerce will automatically apply tax calculations to Carts in this Region. When unchecked you will have to manually compute taxes at checkout. Manual taxes are recommended if using a 3rd party tax provider to avoid performing too many requests"
            }
          />
        </div>
        <div className="item-center flex gap-x-1.5">
