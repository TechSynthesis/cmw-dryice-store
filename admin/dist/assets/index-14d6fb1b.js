import{d5 as ur,d as $}from"./index-c507dc5b.js";import{d as Wr}from"./a-0746c28a.js";import"./layout-f1585c6f.js";import"./index-41453311.js";import"./index-b1992c76.js";import"./index-8fae0651.js";import"./index-9565e0c6.js";import"./index-598e690d.js";var m={},X={};for(var vr=[],y=0;y<64;)vr[y]=0|4294967296*Math.sin(++y%Math.PI);function Hr(r){var a,e,t,n=[a=1732584193,e=4023233417,~a,~e],i=[],o=unescape(encodeURI(r))+"",l=o.length;for(r=--l/4+2|15,i[--r]=8*l;~l;)i[l>>2]|=o.charCodeAt(l)<<8*l--;for(y=o=0;y<r;y+=16){for(l=n;o<64;l=[t=l[3],a+((t=l[0]+[a&e|~a&t,t&a|~t&e,a^e^t,e^(a|~t)][l=o>>4]+vr[o]+~~i[y|15&[o,5*o+1,3*o+5,7*o][l]])<<(l=[7,12,17,22,5,9,14,20,4,11,16,23,6,10,15,21][4*l+o++%4])|t>>>-l),a,e])a=0|l[1],e=l[2];for(o=4;o;)n[--o]+=l[o]}for(r="";o<32;)r+=(n[o>>3]>>4*(1^o++)&15).toString(16);return r}const Gr=Object.freeze(Object.defineProperty({__proto__:null,default:Hr},Symbol.toStringTag,{value:"Module"})),jr=ur(Gr);var sr={exports:{}};(function(r,a){(function(e,t){r.exports=function(n,i,o,l,f){for(i=i.split?i.split("."):i,l=0;l<i.length;l++)n=n?n[i[l]]:f;return n===f?o:n}})()})(sr);var B=sr.exports;/**
* @license Apache-2.0
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var _=Object.prototype,Q=_.toString,Y=_.__defineGetter__,Z=_.__defineSetter__,ba=_.__lookupGetter__,Aa=_.__lookupSetter__;function da(r,a,e){var t,n,i,o;if(typeof r!="object"||r===null||Q.call(r)==="[object Array]")throw new TypeError("invalid argument. First argument must be an object. Value: `"+r+"`.");if(typeof e!="object"||e===null||Q.call(e)==="[object Array]")throw new TypeError("invalid argument. Property descriptor must be an object. Value: `"+e+"`.");if(n="value"in e,n&&(ba.call(r,a)||Aa.call(r,a)?(t=r.__proto__,r.__proto__=_,delete r[a],r[a]=e.value,r.__proto__=t):r[a]=e.value),i="get"in e,o="set"in e,n&&(i||o))throw new Error("invalid argument. Cannot specify one or more accessors and a value or writable attribute in the property descriptor.");return i&&Y&&Y.call(r,a,e.get),o&&Z&&Z.call(r,a,e.set),r}var ma=da;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ha=ya,ga=_a,Sa=ma,T;ha()?T=ga:T=Sa;var Oa=T;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ce=le,w=ue,k=se;function $e(){var r,a;if(typeof k!="function")return!1;try{a=[1,3.14,-3.14,w+1,w+2],a=new k(a),r=ce(a)&&a[0]===1&&a[1]===3&&a[2]===w-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var ye=$e;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function de(){throw new Error("not implemented")}var me=de;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var he=_e,ge=Ae,Se=me,L;he()?L=ge:L=Se;var V=L;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var it=typeof Uint8Array=="function"?Uint8Array:void 0,ot=it;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function lt(){throw new Error("not implemented")}var ft=lt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ut=nt,vt=ot,st=ft,W;ut()?W=vt:W=st;var ct=W;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ht=typeof Uint16Array=="function"?Uint16Array:null,gt=ht;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var St=At,I=mt,er=gt;function Ot(){var r,a;if(typeof er!="function")return!1;try{a=[1,3.14,-3.14,I+1,I+2],a=new er(a),r=St(a)&&a[0]===1&&a[1]===3&&a[2]===I-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var wt=Ot;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Bt=q,mr,G,j;Bt===!0?(G=1,j=0):(G=0,j=1);mr={HIGH:G,LOW:j};var Vt=mr;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Jt=V,qt=J,hr=Vt,gr=new qt(1),nr=new Jt(gr.buffer),xt=hr.HIGH,zt=hr.LOW;function Kt(r,a,e,t){return gr[0]=r,a[t]=nr[xt],a[t+e]=nr[zt],a}var Sr=Kt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var tn=V,nn=J,on=en,Nr=new nn(1),ln=new tn(Nr.buffer);function fn(r){return Nr[0]=r,ln[on]}var un=fn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var mn=la,hn=ua,gn=wr,Sn=Ir,On=Tr,E=[0,0];function wn(r,a){var e,t;return gn.assign(r,E,1,0),e=E[0],e&=hn,t=Sn(a),t&=mn,e|=t,On(e,E[1])}var Nn=wn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ei=cr,ti=$r,ni=yr,ii=xr,oi=Kr,li=Yr,fi=pr,ui=_r,vi=En,si=qn,ci=ai,$i=wr,yi=Tr,pi=2220446049250313e-31,_i=2148532223,U=[0,0],P=[0,0];function bi(r,a){var e,t;return r===0||fi(r)||ui(r)?r:(si(U),r=U[0],a+=U[1],a+=ci(r),a<li?vi(0,r):a>ii?r<0?ti:ei:(a<=oi?(a+=52,t=pi):t=1,$i(P),e=P[0],e&=_i,e|=a+ni<<20,t*yi(e,P[1])))}var Ai=bi;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
